import {AUTH0_PASSWORD, AUTH0_USERNAME, SNIPPET_MANAGER_URL} from "../../src/utils/constants";
...
describe('Add snippet tests', () => {
  ...
  beforeEach(() => {
    ...
    // cy.intercept('GET', SNIPPET_MANAGER_URL+"/snippets/*", {
    //   statusCode: 201,
    //   body: fakeStore.getSnippetById("1"),
    // }).as("getSnippetById")
    cy.intercept('GET', SNIPPET_MANAGER_URL+"/snippets/getAll*").as("getSnippets")
